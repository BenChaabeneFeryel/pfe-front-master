            ...
            <div className='Group-table'>
                <MaterialTable icons={tableIcons}  title="Details  par zone travail"  localization={localization} data={tableZone}
                    columns={[
                        ...
                        { title: 'Quantité totale collectée plastique', field: 'quantite_total_collecte_plastique' },
                        { title: 'Quantité totale collectée papier', field: 'quantite_total_collecte_papier' },
                        { title: 'Quantité totale collectée composte', field: 'quantite_total_collecte_composte' },
                        { title: 'Quantité totale collectée canette', field: 'quantite_total_collecte_canette'},  
                            ...
                            <div style={{margin:'10px',maxWidth:"1350px"}}>
                                <MaterialTable icons={tableIcons}  title="Détails des établissements" localization={localization} data={rowData.etablissements}
                                    columns={[
                                        ...
                                        { title: 'Quantité déchets plastique', field: 'quantite_dechets_plastique'}, 
                                        { title: 'Quantité déchets composte', field: 'quantite_dechets_composte'}, 
                                        { title: 'Quantité déchets papier', field: 'quantite_dechets_papier' }, 
                                        { title: 'Quantité déchets canette', field: 'quantite_dechets_canette'}, 
