    ...
    <>
      <div className="footerSection">
        ...
        <div className='section'>
          ...
          <a className="footerLink" href="#statistique">Statistiques</a> <br></br>
          <a className="footerLink" href="#mission">Mission</a> <br></br>
          <a className="footerLink" href="#contact">Contact </a> <br></br>
        </div>
        ...
        <div className='section'>
          ...
          <a className="footerLink" href="#politique-confidentialite">Politique de confidentialité</a> <br></br>  
        </div>

        <div className='section-last'>
          <p className='title-footer'>Informations de Contact</p>  
      ...
      <div id="bottom" className='copy-right'>
        <p className='copy-right-text'>@copyright 2022 par l'équipe de RE:SCHOOL ECOLOGY, Tous droits réservés</p>
      </div>              
    </>
  );
}
