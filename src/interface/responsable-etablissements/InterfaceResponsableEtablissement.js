...
export default function InterfaceResponsableEtablissement() {
  ...
  return (
    <div id="css-vars-custom-theme">
      <CssVarsProvider theme={theme} colorSchemeNode={color || null} colorSchemeSelector="#css-vars-custom-theme" 
        colorSchemeStorageKey="custom-theme-color-scheme" modeStorageKey="custom-theme-mode">
        <Box bgcolor="background.paper" sx={{ p: 1 }}>
          <Box sx={{ display: 'flex' }}>
              ...
              <Toolbar>
                <Box sx={{marginRight: 5, ...(open && { display: 'none' })  }}>
                  <div  style={{fontWeight:"bold", color:"white" ,margin:"0 0 0 -15px",fontFamily: 'Fredoka'}}>
                    <img alt='logo' src={Logo} style={{verticalAlign: "middle", marginRight:"20px", width:"60px", borderRadius:"50%"}}/>               
            ...
            <Drawer variant="permanent" PaperProps={{sx:{backgroundColor:'primary.main'}}} open={open}>
              <div  style={{fontWeight:"bold", color:"white" ,margin:"9px 10px",fontFamily: 'Fredoka'}}>
                <img src={Logo} alt="reschool-ecology" style={{verticalAlign: "middle", width:"40px", borderRadius:"50%"}}/>
                <span style={{fontSize:"18px"}} > RE:SCHOOL Ecology </span>
          ...
          <Box open={open} sx={{ position:"fixed", bottom:0, width:'100%', height:30, textAlign:'center'}}>
            <Box>
              RE:SCHOOL Ecology © 2022    
              <a href='https://www.facebook.com/RESCHOOL.EDUCATION/'> Facebook</a>
              <a href='https://reschoolecology.tech/'> Site web</a>
            </Box>
          </Box>
        </Box>
      </CssVarsProvider>
